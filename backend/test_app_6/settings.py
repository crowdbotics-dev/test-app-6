"""
Django settings for test_app_6 project.
...
WSGI_APPLICATION = 'test_app_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_6 API",
    "DESCRIPTION": "API documentation for test_app_6 App",
    "VERSION": "v1",
}
